...
# Django admin/auth/session uses SQLite.
# EchoTale app data uses MongoDB Atlas through MongoEngine.
DATABASES = {
    "default": {
...
# Required for UserDocument.objects(...), StoryDocument.objects(...), etc.
if MONGODB_URI:
    connect(
        host=MONGODB_URI,
        alias="default",
