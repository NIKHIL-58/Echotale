...
export function HeroBanner() {
  return (
    <section className="relative isolate overflow-hidden rounded-[30px] border border-white/10 bg-[#0b0920] px-6 py-8 text-white shadow-[0_26px_70px_rgba(26,16,72,.20)] sm:px-9 md:min-h-[330px] md:px-11 md:py-10">
      ...
      <div className="relative z-10 max-w-[650px]">
        ...
        <h1 className="max-w-xl text-4xl font-black leading-[1.01] tracking-[-.052em] sm:text-[46px]">Your next great story starts here.</h1>
